...
with col2:
    for flight in flights:
        ...
        with st.expander(f":orange[{overall_departure_time_fm} - {overall_arrival_time_fm}, {city_from}/{fly_from} - {city_to}/{fly_to}, total_hours: {total_hours:.1f}, #Connects:{connection_number}, Price:{price}USD]"):
            st.json(flight)
